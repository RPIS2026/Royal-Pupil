  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-14 h-14 bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] text-white rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(225,48,108,0.4)] hover:scale-110 transition-transform cursor-pointer"
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform cursor-pointer"
